...
public class StaleElementRefExceptionConcept {
	...
	public static void main(String[] args) {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("Form_submitForm_Name"))).sendKeys("Harshini");

		// fn.sendKeys("Parag");//StaleElementReferenceException-stale element
