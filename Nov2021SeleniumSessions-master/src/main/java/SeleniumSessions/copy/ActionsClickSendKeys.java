...
//		act.sendKeys(driver.findElement(fn), "Parag").perform();
//		act.sendKeys(driver.findElement(ln), "Chougule").perform();
//		act.click(driver.findElement(login)).perform();
//		
		doActionsSendKeys(fn, "Parag");
		doActionsSendKeys(ln, "Chougule");
